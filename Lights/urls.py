...
urlpatterns = [
	...
	url(r'^page/(?P<page>\w+)/$', handleLightView.as_view(), name='LightPage'),
	url(r'^page/(?P<house>\w+)/(?P<page>\w+)/$', handleLightView.as_view(), name='LightPage'),
	url(r'^page/(?P<house>\w+)/(?P<room>\w+)/(?P<page>\w+)/$', handleLightView.as_view(), name='LightPage'),
	...
	url(r'^(?P<house>\w+)/(?P<room>\w+)/(?P<lightType>\w+)/(?P<lightId>\d+)/$', handleLightView.as_view(), name='Lights'),
]
