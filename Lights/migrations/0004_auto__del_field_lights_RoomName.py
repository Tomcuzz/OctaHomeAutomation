...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Lights.RoomName'
        db.delete_column(u'Lights', 'RoomName')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Lights.RoomName'
        raise RuntimeError("Cannot reverse this migration. 'Lights.RoomName' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Lights.RoomName'
        db.add_column(u'Lights', 'RoomName',
