...
urlpatterns = [
	...
	url(r'^Display/(?P<house>\w+)/$', handleGenericDeviceView.as_view(), name='GenericDeviceSection'),
	url(r'^Display/(?P<house>\w+)/(?P<room>\w+)/$', handleGenericDeviceView.as_view(), name='GenericDeviceSection'),
]
