...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'custom-user_customuser', (
        ...
        db.send_create_signal(u'custom-user', ['CustomUser'])


    def backwards(self, orm):
        # Deleting model 'CustomUser'
        db.delete_table(u'custom-user_customuser')


    models = {
        u'custom-user.customuser': {
